...
// app.post('/bind_phone', routes.bind_phone);
// app.post('/found_shadow', routes.foundShadow);
// app.post('/visit_someone', routes.visitSomeone);
// app.post('/like_or_hate', routes.likeOrHate);
...
app.get('/data_shadow', data.found_shadow);
app.get('/data_message', data.message);
app.get('/data_email', data.email);
